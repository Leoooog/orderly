...
final List<MenuItem> menuItems = [
  MenuItem(
      ...
      popular: true,
      imageUrl:
          'https://images.unsplash.com/photo-1548839140-29a749e1cf4d?auto=format&fit=crop&w=150&q=80',
      ingredients: const ['Acqua oligominerale naturale'],
      allergens: const [],
  ...
  MenuItem(
      ...
      ingredients: const ['Acqua', 'Zucchero', 'Caffeina'],
      allergens: const [],
      availableExtras: [extraGhiaccio, extraLimone]),
  MenuItem(
      id: 3,
      ...
      ingredients: const ['Prosecco', 'Aperol', 'Soda'],
      allergens: const ['Solfiti'],
  ...
  MenuItem(
      ...
      popular: true,
      imageUrl:
          'https://images.unsplash.com/photo-1612874742237-6526221588e3?auto=format&fit=crop&w=150&q=80',
      ingredients: const ['Spaghetti', 'Tuorlo', 'Guanciale', 'Pecorino'],
      allergens: const ['Glutine', 'Uova', 'Latte'],
  ...
  MenuItem(
      ...
      popular: false,
      imageUrl:
          'https://images.unsplash.com/photo-1574868309603-c1b9aa53de63?auto=format&fit=crop&w=150&q=80',
      ingredients: const ['Bucatini', 'Pomodoro', 'Guanciale'],
  ...
  MenuItem(
      ...
      popular: true,
      imageUrl:
          'https://images.unsplash.com/photo-1600891964092-4316c288032e?auto=format&fit=crop&w=150&q=80',
      ingredients: const [
        'Manzo',
        'Rucola',
        'Grana'
      ...
      availableExtras: [
        extraRucola,
        extraGrana,
        Extra('patate', 'Contorno Patate', 4.0)
      ]),
  MenuItem(
      id: 10,
      name: 'Espresso',
      ...
      allergens: const [],
      availableExtras: [
        Extra('macchiato', 'Macchiato', 0.0),
        Extra('corretto', 'Corretto Grappa', 1.0)
      ]),
];

// Stato Globale dei tavoli (Singleton simulation)
final List<TableItem> globalTables = List.generate(
    15,
    (i) => TableItem(
        id: i + 1,
        name: 'T${i + 1}',
